  ...
  return (
    <footer className="w-full bg-gradient-to-br from-blue-600 via-blue-700 to-blue-950 text-blue-100 pt-10 pb-4 px-6">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-5 gap-8">
        ...
        <div>
          <h3 className="text-lg font-semibold mb-4 text-white">Trang cá nhân</h3>
          <ul className="space-y-2 text-sm">
            <li><a href="/dashboard" className="hover:text-white hover:underline">Dashboard</a></li>
            <li><a href="/profile" className="hover:text-white hover:underline">Hồ sơ</a></li>
            <li><a href="/settings" className="hover:text-white hover:underline">Cài đặt</a></li>
            <li><a href="/notifications" className="hover:text-white hover:underline">Thông báo</a></li>
            <li><a href="/support" className="hover:text-white hover:underline">Hỗ trợ</a></li>
          </ul>
        </div>

        {/* Phòng - Ban (có thể giữ như cũ) */}
        <div>
